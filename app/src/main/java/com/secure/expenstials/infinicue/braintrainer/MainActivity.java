package com.secure.expenstials.infinicue.braintrainer;
...
public class MainActivity extends AppCompatActivity {
    ...
    TextView sumTextView, timerTextView, pointsTextView, resultTextView;
    ...
    public void playAgain(View view) {
        ...
        new CountDownTimer(30100, 1000) {
            ...
            public void onFinish() {
                ...
                resultTextView.setText("Your score: " + String.valueOf(score) + "/" + String.valueOf(numberOfQuestions));
            }
        }.start();
    }
}
